...
public class studentregistrationform extends JFrame implements ActionListener {
    ...
    private final JRadioButton civilRadio;
    private final JRadioButton cseRadio;
    private final JRadioButton electricalRadio;
    private final JRadioButton encRadio;
    private final JRadioButton mechanicalRadio;
    private final ButtonGroup deptGroup;
    private final JTextArea displayArea;
    private final JButton submitBtn;
    private final JButton cancelBtn;
    // Error labels (shown in red below each relevant field)
    private final JLabel errFirst;
    private final JLabel errLast;
    private final JLabel errEmail;
    private final JLabel errConfirmEmail;
    private final JLabel errPass;
    private final JLabel errConfirmPass;
    private final JLabel errDob;
    private final JLabel errGender;
    private final JLabel errDept;
